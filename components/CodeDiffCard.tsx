...
//
// Hover-Tilt: outer wrapper holds the perspective, inner card translates +
// rotates slightly on hover. Respects prefers-reduced-motion via Tailwind’s
// motion-safe selectors.
...
export default function CodeDiffCard() {
  return (
    ...
    >
      <div
        className="relative overflow-hidden rounded-2xl border border-border bg-mono-bg shadow-accent-glow transition-transform duration-500 ease-out motion-safe:group-hover:[transform:rotateY(-4deg)_rotateX(3deg)_translateY(-4px)]"
        role="img"
