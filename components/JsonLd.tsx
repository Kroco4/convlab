...
const faqs: [string, string][] = [
  ...
  ["Wie viele Kunden auf einmal?", "Max 2 parallel. So bleibt der Service deep, nicht oberflächlich. Slots sind knapp."],
  ["Was wenn ich keinen Next.js / Modern-Stack habe?", "Schreib mir vor dem Buchen. Aktiv unterstützte Stacks: Next.js, Nuxt, Remix, SvelteKit, Astro, Vite + React. Legacy-Stacks lehne ich ab (kein Wordpress / kein Webflow)."],
  ["Was wenn du keine 3 Bugs findest?", "Dann zahlst du nichts. Bug-Findungs-Garantie. In der Praxis: hatte ich noch nie."],
  ["Was passiert mit meinem Code und meinen Daten?", "Alles read-only wo möglich: eigener Branch, eingeschränkter Stripe-Key, keine Passwörter. Nach Audit-Abschluss lösche ich alle lokalen Kopien. NDA gerne, schreib mir vor Buchung."],
  ...
  ["Wieviel Aufwand entsteht für mich?", "~2-3 Stunden ueber eine Woche: Discovery-Call, Kickoff, Zugänge geben, Code-PR mergen, Debrief-Call."],
  ...
  const data = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        serviceType: "Conversion-Rate-Audit für SaaS",
        provider: { "@id": `${SITE_URL}/#org` },
        areaServed: ["CH", "DE", "AT"],
        description:
          "7-Tage-Funnel-Audit für DACH SaaS-Solo-Founder: die 3 grössten Conversion-Bugs gefunden und direkt im Code gefixt. Bug-Findungs-Garantie.",
        offers: {
          "@type": "Offer",
          price: "1490",
          priceCurrency: "CHF",
